...
function selectType(value) {
    if (typeSelector.value === "sheep") {
        traits = ["Fur", "Head", "Ears", "Eyes", "Nose", "Mouth", "Feet", "BG"];
        assets = [
        ...
        traits = ["Fur", "Head", "Eyes", "Mouth", "Neck", "BG"];
        assets = [
            ...
            img.onload = function () {
                ...
                if (loaded === render_layers.length) {
                    for (let j = 0; j < render_layers.length; j++) {
                        ...
                        if (!render_layers[j].includes("BG")) ctx.drawImage(img, 15, 15, canvas.width - 30, canvas.height - 30);
                        else {
